...
namespace JwtAuthServer.Providers
{
    public class CustomJwtFormat : ISecureDataFormat<AuthenticationTicket>
    {
        ...
        public string Protect(AuthenticationTicket data)
        {
            ...
            //var file = File.OpenRead(@"c:\temp\Server.pvk");
            //file.Close();
            ...
            var token = new JwtSecurityToken(_issuer, audienceId, data.Identity.Claims, issued.Value.UtcDateTime, expires.Value.UtcDateTime,
                ...
                signingCredentials: new SigningCredentials(new RsaSecurityKey(privateKey), SecurityAlgorithms.RsaSha1Signature, SecurityAlgorithms.Sha1Digest)
                );
